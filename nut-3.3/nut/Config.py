...
def load(confFile):  # pylint: disable=too-many-branches,too-many-statements
    ...
    with open(confFile, encoding='utf8') as f:
        try:
            ...
            # use normal print because of initialization order of Status / Print
            print('Failed to load config file: %s' % confFile)
            raise
        ...
        try:
            server.enableLocalDriveAccess = int(
                j['server']['enableLocalDriveAccess'])
        except BaseException:  # pylint: disable=broad-except
            pass
...
class Cdn:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self):
        ...
        self.clientIds = {"eShop": "93af0acb26258de9", "atumC1": "3117b250cab38f45",
                          "tigers": "d5b6cac2c1514c56", "tagaya": "41f4a6491028e3c4"}
